  ...
  return (
    <Routes>
      <Route element={<MainLayout />}>
        ...
        <Route path="/advertisements/create" element={<ProtectedRoute><CreateAdvertisementPage /></ProtectedRoute>} />
        <Route path="/saved" element={<ProtectedRoute><SavedAdvertisementsPage /></ProtectedRoute>} />
